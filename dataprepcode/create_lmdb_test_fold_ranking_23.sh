...
DATA=cnn2ranking/
DEF_FILES=cnn2ranking/folds/train_val_txt_files_per_ranking/test_fold_ranking_23
OUT=cnn2ranking/folds/train_val_txt_files_per_ranking/test_fold_ranking_23
